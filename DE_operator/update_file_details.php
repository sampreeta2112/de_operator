		 ...
		 <div id="row_wrap">
			...
			<div class="row"> 
				...
				<div class="form-group">
						...
						value="<?php echo$file_inwarddate; ?>" placeholder="Name"  />
					</div> 
					<div class="form-group" style="opacity: 0;">
						
						<input type="hidden" class="form-control " id="para5" name="fileclosedate" value="<?php echo$fileclosedate; ?>" placeholder="Parameter 5"  />
					</div>
				</div>
