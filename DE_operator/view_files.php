...
<div class="col-sm-4" id="" style="width: 490px; height: 205px; margin-left: -80px; ">
	  	   ...
	  	   <div class="col-sm-9" id="" style="width: 450px; height: 80px; margin-top: 10px; font-family: calibri;">
 <input type="checkbox" name="items" id="selectitem" value="" onclick="checkAll();"> Select All <br>
    ...
    <input type="checkbox" name="items"  id="left"  value="ODS" class="first">ODS 
     <input type="checkbox" name="items" value="PCNs"  id="left" class="first">PCNs
      <input type="checkbox" name="items" value="HBCCD" class="first" style="margin-left: 30px;"> HBCCD<br>
...
<input type="checkbox" name="items" value="PBBS" class="first" style="margin-left: 29px;">PBBS<br> 
<input type="checkbox" name="items" value="Radioactive" class="first">Radioactive 

<input type="checkbox" name="items" value="PBCEDEs" class="first" style="margin-left: 20px;"> PBCEDEs

  <input type="checkbox" name="items"   id="left"  value="Hg" class="first" style="margin-left: 4px;"> Hg 
  
   
  <input type="checkbox" name="items" value="Cd" class="first" style="margin-left: 47px;">  Cd 
   
  <input type="checkbox" name="items" value="Sccps" class="first" style="margin-left: 44px;"> Sccps
			...
			<div class="col-sm-9"  style="margin-top: 10px; width: 100px;font-family: calibri;">	
	...
	<div class="row">
        ...
        <td class='rotated_cell' id="tb">
         ...
         <td class='rotated_cell' id="tb">
            ...
            <div class='rotate_text' >HBCCD</div></td>
            <td class='rotated_cell' id="tb">
            ...
            <td class='rotated_cell' id="tb1" >
            <div class='rotate_text'>Hazmat(Y/N)</div>
         </td>
         </td><td class='rotated_cell' id="tb2"><div class='rotate_text'>Edit</div>
         </td>
          
         <td class='rotated_cell' id="tb2">
