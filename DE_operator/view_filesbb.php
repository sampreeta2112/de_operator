...
<div id="row_wrap"  >
	...
	<label id="textbox1" >IMO NO: </label>9365790<br>
								...
								<input type="text"  id="textbox2" name="file_no" value="<?php echo$file_no; ?>" placeholder="" style="margin-left: 5px;"><br>
								...
								<input type="text"  id="textbox" name="file_no" value="<?php echo$file_no; ?>" placeholder="" style="margin-left: 15px;"><br>
...
<div class="col-sm-4" id="" style="width: 550px; height: 205px; margin-left: -70px; ">
  ...
  <input type="checkbox" name="items" id="selectitem" value="" onclick="checkAll();"> Select All <br>
    <input type="checkbox" name="asbestos" value="Asbestos" class="first">Asbestos
  ...
  <input type="checkbox" name="pb" value="Pb" class="first" style="margin-left: 30px;" >  Pb
        ...
        <div class='rotate_text'>Delete</div>
					...
					if (isset($_POST['asbestos']))
					{
						$cond4 = $_POST['asbestos'];
							...
							$q = "";
						if($cond!='' or $cond1!='' or $cond2!='' or $cond3!='' or $cond4!='')
							{
					 
					
								
								$q = " select * from file_records  where report_no='$cond' OR expert_co='$cond1' OR items_detail='$cond2' or pb='$cond3' and asbestos='$cond4' or asbestos='$cond4' "; 
							}
	...
	$hbccd=$o->hbccd;	
						...
						?>
							<tr>
								...
								<td><CENTER><?php echo IMG_DELETE;?></a></CENTER></td> 		
							</tr>
						<?php
